        ...
        <div class="content-wrapper">
            ...
            <?php
                if ($_SERVER['REQUEST_METHOD'] == "POST") {
                    ...
                    $query = " UPDATE tbldriver SET dname = '{$dname}', dcontactno = '{$dcontactno}', daltno = '{$daltno}', dgender = '{$dgender}', ddob = '{$ddob}', daddress = '{$daddress}', dstate = '{$dstate}', ddist = '{$ddist}', dpin = '{$dpin}', dbloodgroup = '{$dbloodgroup}', ddlno = '{$ddlno}' WHERE tbldriver.did ='{$v_id}'";
            ...
            <div class="container m-1">
                <form class="row g-3" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="dcontactno" value="<?php echo $row['dcontactno']; ?>">
                    </div>
                    <!-- Date -->
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="ddob" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask value="<?php echo $row['ddob']; ?>">
                            </div>
                    </div>
                    <!-- date end -->
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control" name="daddress" rows="1" value="<?php echo $row['daddress']; ?>"></textarea>
                    </div>
                    <div class="col-md-6">
                        <label for="inputState" class="form-label">State<span style="color:red">*</span></label>
                        <input type="text" class="form-control" name="dstate" value="<?php echo $row['dstate']; ?>">
                    </div>
                    <div class="col-md-6">
                        <label for="indputdist" class="form-label">Dist<span style="color:red">*</span></label>
                        <input type="text" class="form-control" name="ddist" value="<?php echo $row['ddist']; ?>">
                    </div>
                    <div class="col-md-6">
                        <label for="citypin" class="form-label">Pin<span style="color:red">*</span></label>
                        <input type="text" class="form-control" name="dpin" value="<?php echo $row['dpin']; ?>">
                    </div>
                    <div class="col-md-6">
                        <label for="inputCity" class="form-label">Blood Group<span style="color:red">*</span></label>
                        <input type="text" class="form-control" name="dbloodgroup" value="<?php echo $row['dbloodgroup']; ?>">
                    </div>
                    <div class="col-md-6">
                        <label for="year" class="form-label">Driving Lic. NO.<span style="color:red">*</span></label>
                        <input type="text" class="form-control" name="ddlno" value="<?php echo $row['ddlno']; ?>">
                    </div>
                    <div class="col-md-6">
                        <label for="capacity" class="form-label">Releted Vehicle no.<span style="color:red">*</span></label>
                        <input type="text" class="form-control" name="dvehicleno" value="<?php echo $row['dvehicleno']; ?>">
                    </div>
                    <div class="col-md-6">
                        <label for="capacity" class="form-label">Alter phone no.<span style="color:red">*</span></label>
                        <input type="text" class="form-control" name="daltno" value="<?php echo $row['daltno']; ?>">
                    </div>
                    <div class="hr-dashed"></div>


                    <div class="col-12">
                        <button type="submit" class="btn btn-primary"><a href="driver_info.php" style="color: white">Update Driver</a></button>
                    </div>
                </form>
            </div>
            <!-- Main Content End -->
