    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            if ($_SERVER['REQUEST_METHOD'] == "POST") {
                ...
                $imgContent1 = addslashes(file_get_contents($vimg1));
                $vimg2 = $_FILES['img2']['tmp_name'];
                $imgContent2 = addslashes(file_get_contents($vimg2));
                $vimg3 = $_FILES['img3']['tmp_name'];
                $imgContent3 = addslashes(file_get_contents($vimg3));
                $vimg4 = $_FILES['img4']['tmp_name'];
                $imgContent4 = addslashes(file_get_contents($vimg4));
                $vimg5 = $_FILES['img5']['tmp_name'];
                $imgContent5 = addslashes(file_get_contents($vimg5));
                $vimg6 = $_FILES['img6']['tmp_name'];
                $imgContent6 = addslashes(file_get_contents($vimg6));

                $ac = $_POST['ac'];
                $airbag = $_POST['airbag'];
                // vimg1 = '{$vimg1}',vimg2 = '{$vimg2}',vimg3 = '{$vimg3}',vimg4 = '{$vimg4}',vimg5 = '{$vimg5}',vimg6 = '{$vimg6}' ,
                $sql = "UPDATE car SET vtitle = '{$vtitle}' ,vbrand = '{$vbran}', voverview = '{$voverview}', pdprice = '{$pdprice}', ftype = '{$ftype}', myear = '{$myear}', scapacity = '{$scapacity}',  ac = '{$ac}',  airbag = '{$airbag}'  WHERE vid = '{$v_id}'";
            ...
            <div class="container m-1">
                <form class="row g-3" method="post" action="<?php $_SERVER['PHP_SELF']; ?>">
                    ...
                    <div class="form-group">
                        <div class="col-sm-4">
                            Image 1 <input type="file" name="img1" value="<?php echo $row['vimg1']; ?>">
                        </div>
                        <div class="col-sm-4">
                            Image 2<input type="file" name="img2" value="<?php echo $row['vimg2']; ?>">
                        </div>
                        <div class="col-sm-4">
                            Image 3<input type="file" name="img3" value="<?php echo $row['vimg3']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-4">
                            Image 4<input type="file" name="img4" value="<?php echo $row['vimg4']; ?>">
                        </div>
                        <div class="col-sm-4">
                            Image 5<input type="file" name="img5" value="<?php echo $row['vimg5']; ?>">
                        </div>

                        <div class="col-sm-4">
                            Image 6<input type="file" name="img6" value="<?php echo $row['vimg6']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" name="ac" type="checkbox" id="gridCheck">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" name="airbag" type="checkbox" id="gridCheck">
                            <label class="form-check-label" for="gridCheck">
                                <?php echo $row['airbag']; ?>
                                Airbag (Safety)
                            </label>
