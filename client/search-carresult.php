...
$sql = "SELECT vid from car where vbrand=:brand and ftype=:fueltype";
...
$sql = "SELECT *  from car where vbrand=:brand and ftype=:fueltype";
$query = $dbh -> prepare($sql);
$query -> bindParam(':brand',$brand, PDO::PARAM_STR);
$query -> bindParam(':fueltype',$fueltype, PDO::PARAM_STR);
$query->execute();
...
{  ?>
        <div class="product-listing-m gray-bg">
          <div class="product-listing-img"><img src="<?php echo "data:image/jpeg;base64,".base64_encode($result->vimg1);?> " class="img-responsive" alt="Image" /> </a> 
          </div>
          <div class="product-listing-content">
            ...
            <a href="vehical-details.php?vid=<?php echo htmlentities($result->vid);?>" class="btn">View Details <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
          </div>
        </div>
      <?php }} ?>
         </div>
            ...
            <form action="search-carresult.php" method="post">
              <div class="form-group select">
                <select class="form-control" name="brand">
                  ...
                  <?php $sql = "SELECT MIN(vid) AS id, vbrand FROM car GROUP BY vbrand";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
foreach($results as $result)
{       ?>  
<option value="<?php echo htmlentities($result->vbrand);?>"><?php echo htmlentities($result->vbrand);?></option>
<?php }} ?>
...
<option value="CNG">CNG</option>
        ...
        <div class="sidebar_widget">
          ...
          <div class="recent_addedcars">
            <ul>
<?php $sql = "SELECT car.* from car order by vid desc limit 4";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
