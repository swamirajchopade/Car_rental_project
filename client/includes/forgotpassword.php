...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT email FROM tbluser WHERE email=:email and contactno=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tbluser set Password=:newpassword where email=:email and contactno=:mobile";
